To run the page:
1) If you do not already have, install Python 3.5 (or upper) and the dependencies listed in "environment.yml" (if you use conda, you can create a new environment directly from the file).
